...
function App() {
  ...
  const sidebarItems = [
    ...
    { title: 'Offered Services', icon: <FontAwesomeIcon icon={faClipboardCheck} /> },
    ...
    { title: 'Payment Gateways', icon: <FontAwesomeIcon icon={faCreditCard} /> },
  ...
  return (
    <Layout style={{height: "auto", width:"99vw" }}>
      ...
      <Layout>
        ...
        <Content className="content-Section"> <Customer /></Content>
      </Layout>
    </Layout>
  );
}
